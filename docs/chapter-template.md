...
- Wrap minimal implementation code blocks in `<details><summary>Expand minimal Python implementation</summary>...</details>` so that they are expandable by the reader.
