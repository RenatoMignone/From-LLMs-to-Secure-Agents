...
- Purpose: Teach queues, concurrency, timeouts, retries, budgets, rate limits, fallbacks, durable execution, and deployment lifecycle.
- Reader prerequisite: the parent section and all earlier sibling plans.
- May assume: state, observability, and evaluation.
- Do not cover yet: detailed denial-of-service attacks or security incident response.
