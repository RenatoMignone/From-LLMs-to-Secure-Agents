...
- Purpose: Teach model roles, selection, routing, fallback, and inference trade-offs.
- Reader prerequisite: the parent section and all earlier sibling plans.
- May assume: model calls and agent architectures.
- Do not cover yet: model internals beyond operational choice.
